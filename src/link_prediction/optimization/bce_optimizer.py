...
from src.link_prediction.models.model import Model, BATCH_SIZE, LABEL_SMOOTHING, LEARNING_RATE, DECAY, EPOCHS
...
class BCEOptimizer(Optimizer):
    ...
    def extract_batch(self, er_vocab, er_vocab_pairs, batch_start, batch_size):
        ...
        if torch.cuda.is_available():
            ...
            return torch.tensor(np.array(batch)), torch.FloatTensor(targets)
