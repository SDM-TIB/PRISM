...
from src.link_prediction.models.model import Model, DIMENSION, INIT_SCALE, KelpieModel
...
class DistMult(Model):
    ...
    def all_scores(self, samples: np.array):
        ...
        rel_embeddings = self.relation_embeddings[samples[:, 1].tolist()]    # list of relation embeddings for the relations of the heads
