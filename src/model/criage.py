...
from src.prefilters.criage_prefilter import CriagePreFilter
from src.explanation_builders.criage_necessary_builder import CriageNecessaryExplanationBuilder
from src.explanation_builders.criage_sufficient_builder import CriageSufficientExplanationBuilder
...
class Criage:
    ...
    def explain_necessary(self,
        ...
        rules_with_relevance, complexity = explanation_builder.build_explanations(samples_to_remove=top_promising_samples)
