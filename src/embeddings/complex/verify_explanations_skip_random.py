...
from src.link_prediction.models.model import DIMENSION, INIT_SCALE, LEARNING_RATE, OPTIMIZER_NAME, DECAY_1, DECAY_2, \
...
with open("output.txt", "r", encoding="utf8" ) as input_file:
...
if torch.cuda.is_available():
    ...
    original_model.load_state_dict(torch.load(args.model_file))
else:
    kernel = "cpu"
    original_model.load_state_dict(torch.load(args.model_file, map_location=torch.device(kernel)))
