...
from config import EXPLAIN_PATH, LOGGING_PATH, MODEL_PATH, ALL_DATASET_NAMES
from src.link_prediction.models.conve import ConvE
from src.link_prediction.models.model import DIMENSION, LEARNING_RATE, EPOCHS, BATCH_SIZE, INPUT_DROPOUT, FEATURE_MAP_DROPOUT, HIDDEN_DROPOUT, HIDDEN_LAYER_SIZE, LABEL_SMOOTHING, DECAY
...
parser.add_argument("--model_file",
                    type=str,
                    default="TransE_FR_Reduced_2K.pt",
                    #default="TransE_YAGO3-10.pt",
                    #required=True,
...
parser.add_argument("--explanations_to_verify_file",
                    ...
                    #default="TransE_YAGO3-10_explanation.csv",
...
explanations_path = os.path.join(EXPLAIN_PATH, args.explanations_to_verify_file)
...
print(log_path)
log_end_to_end_output_path = os.path.join(LOGGING_PATH, output_prefix + f"_12_{args.dataset}_output_end_to_end.txt")
...
if args.mode == "sufficient":
    ...
    with open("output_end_to_end_skipping_random_facts.txt", "w", encoding="utf8" ) as outfile:
