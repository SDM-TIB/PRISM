...
class SymbolicNecessaryExplanationBuilder(NecessaryExplanationBuilder):
    ...
    def __init__(self, model: Model,
                 ...
                 #max_retrainings:int = None,
                 verbose: bool = True):
        """
        SymbolicNecessaryExplanationBuilder object constructor.
        ...
        self.ruleEvidence = RuleEvidence(ruleset=ruleset, dataset=dataset, engine=engine, perspective=perspective, mode=MODE,sample_to_explain=sample_to_explain, output_prefix=output_prefix, relevance_threshold=relevance_threshold, perspective_entity=self.perspective_entity, verbose=verbose)
    ...
    def build_explanations(self,
        ...
        all_rules_with_relevance, complexity = alg_func(rules_to_remove)
