...
def run_pipeline(config, builder):
    ...
    predictions = config.get("predictions", "FR_100.csv")
...
def main():
    ...
    try:
        with open('input_conve_fr.json', 'r') as file:
            config = json.load(file)
    except FileNotFoundError:
        print("Error: input_conve_fr.json file not found.")
        return
    except json.JSONDecodeError:
        print("Error: input_conve_fr.json contains invalid JSON.")
        return
