...
def run_pipeline(config, builder):
    ...
    exp_id = config.get("exp_id", "_convE_100")  # must start with _
...
def main():
    ...
    try:
        with open('input_conve_db100k.json', 'r') as file:
            config = json.load(file)
    except FileNotFoundError:
        print("Error: input_conve_db100k.json file not found.")
        return
    except json.JSONDecodeError:
        print("Error: input_conve_db100k.json contains invalid JSON.")
        return
